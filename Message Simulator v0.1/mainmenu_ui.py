...
class Mainwindow(QMainWindow):
    ...
    def Mainmenuui(self, MainWindow1):
        ...
        self.background.setPixmap(QtGui.QPixmap("bg.jpg"))
        ...
        self.story1.setStyleSheet("background-color: rgb(170, 255, 255);\n"
            "color: rgb(0, 0, 127);\n"
            "border-image: url(wimpykids.jpg);\n"
    ...
    def story1clicked(self):
        self.close()
        self.story1load = PlayUi("IamDME.json")
